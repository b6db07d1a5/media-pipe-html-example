...
function D(t) {
  ...
  var e = t.Z;
  return null ==
    (e = null == e || F(e) ? e : "string" == typeof e ? R(e) : null)
    ? e
    : (t.Z = e);
}
var B = class {
  constructor(t, e) {
    if ((P(e), (this.Z = t), null != t && 0 === t.length))
...
function X(t) {
  if ("string" == typeof t) return { buffer: R(t), L: !1 };
  if (Array.isArray(t)) return { buffer: new Uint8Array(t), L: !1 };
  if (t.constructor === Uint8Array) return { buffer: t, L: !1 };
  if (t.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t), L: !1 };
  if (t.constructor === B) return { buffer: D(t) || O(), L: !0 };
...
function ot(t, e) {
  ...
  for (32 < s && (i |= (127 & n) >> 4), s = 3; 32 > s && 128 & n; s += 7)
    (n = o[a++]), (i |= (127 & n) << s);
...
function wt(t, e, n) {
  ...
  let o = s - r;
  if (
    (0 >= o && ((t.g.l = s), n(e, t, void 0, void 0, void 0), (o = s - t.g.g)),
    o)
  )
    throw Error(
  ...
  if (((t = t.h), o)) {
    ...
    for (; u < e; ) {
      ...
      128 > l
        ...
        : n(),
        8192 <= a.length && ((s = r(s, a)), (a.length = 0));
    }
    u = r(s, a);
  }
  return u;
...
function Mt(t, e, n) {
  for (; 0 < n || 127 < e; )
    t.g.push((127 & e) | 128), (e = ((e >>> 7) | (n << 25)) >>> 0), (n >>>= 7);
  t.g.push(e);
}
function Ot(t, e) {
    ...
    : (t, e) => {
        void 0 !== t.D
          ...
          : Object.defineProperties(t, {
              D: { value: e, configurable: !0, writable: !0, enumerable: !1 },
            });
      };
function Yt(t) {
  const e = qt(t);
...
function _e(t) {
  return (
    (t = Error(t)).__closure__error__context__984382 ||
...
function ke(t) {
  return (
    "-" !== t[0] &&
    (20 > t.length || (20 === t.length && 184467 > Number(t.substring(0, 6))))
  );
}
function Se(t) {
  return "-" === t[0]
...
function Le(t) {
  return (
    (t = Math.trunc(t)), Number.isSafeInteger(t) || (J(t), (t = tt($, q))), t
  );
}
function Re(t) {
...
function Pe(t, e, n) {
  ...
  return "string" == typeof (n = null == (t = r) ? (n ? 0 : void 0) : t) &&
...
function Ne(t) {
  switch (typeof t) {
    case "boolean":
      return (De ||= [0, void 0, !0]);
    case "number":
      return 0 < t ? void 0 : 0 === t ? (Be ||= [0, void 0]) : [-t, void 0];
    case "string":
      return [0, t];
    case "object":
      return t;
...
var Ye = class extends ze {
  ...
  set(t, e) {
    return (
      ...
      null == (t = this.R(t, !0, !1))
        ...
        : null == e
        ? (super.delete(t), this)
        : super.set(t, this.Y(e, !0, !0, this.V, !1, this.O))
    );
  }
  Ta(t) {
  ...
  get(t) {
    ...
    if (void 0 !== e) {
      var n = this.V;
      return n
        ? ((n = this.Y(e, !1, !0, n, this.xa, this.O)) !== e && super.set(t, n),
          n)
        : e;
    }
  }
    ...
    : (function (t) {
        switch (typeof t) {
          ...
          case "object":
            if (t) {
              if (Array.isArray(t))
                return ce || !ue(t, void 0, 9999) ? t : void 0;
              if (F(t)) return x(t);
              if (t instanceof B) {
                const e = t.Z;
              ...
              if (t instanceof Ye)
                return (t = t.pa()), W || 0 !== t.length ? t : void 0;
            }
        }
        return t;
      })(t);
    ...
    if (Array.isArray(t)) {
      ...
      return 2 & r
        ...
        : ((e &&= 0 === r || (!!(32 & r) && !(64 & r || !(16 & r)))),
          e
            ? (Zt(t, -12293 & (34 | r)), t)
            : Ze(t, en, 4 & r ? ne : n, !0, !1, !0));
    }
    return (
      t.W === ie
        ? ((n = t.s), (t = 2 & (r = Jt(n)) ? t : nn(t, n, r, !0)))
        : t instanceof Ye &&
          ((n = te(t.X(en))), (t = new Ye(n, t.V, t.R, t.Y))),
      t
    );
  }
}
...
function dn(t, e, n) {
  ...
  var o = qt(s);
  if (!(4 & o)) {
    (4 & o || Object.isFrozen(s)) &&
      ((s = Vt(s)), (o = On(o, r, !1)), (r = hn(t, r, e, s)));
    var a = 0;
    let i = 0;
    for (; a < s.length; a++) {
      const t = n(s[a]);
  ...
  return (
    mn(o) ||
      ((n = o),
      (o = (a = 1 === i) ? $t(o, 2, !0) : $t(o, 32, !1)) !== n && Zt(s, o),
      a && Object.freeze(s)),
    2 === i &&
      mn(o) &&
      ((s = Vt(s)), (o = On(o, r, !1)), Zt(s, o), hn(t, r, e, s)),
    s
  );
}
function pn(t, e, n) {
...
function wn(t, e, n) {
  {
    ...
    if ((de(a), null == n)) hn(o, a, e);
      ...
      var r,
        i = (t = qt(n)),
        s = !!(2 & t) || Object.isFrozen(n);
      if (((r = !s) && (r = !1), !(4 & t)))
        for (
          t = 21, s && ((n = Vt(n)), (i = 0), (t = On(t, a, !0))), s = 0;
          s < n.length;
          s++
        )
          n[s] = Me(n[s]);
      r && ((n = Vt(n)), (i = 0), (t = On(t, a, !0))),
        t !== i && Zt(n, t),
        hn(o, a, e, n);
    }
  }
...
function xn(t, e, n, r) {
  ...
  let o;
  if (null != s && s.W === ie)
    return (e = sn(s)) !== s && hn(t, i, n, e, r), e.s;
  if (Array.isArray(s)) {
    const t = qt(s);
...
function Ln(t, e, n, r, i, s) {
  ...
  if (((n = !!(8 & h) || (c && !o.length)), s && !n)) {
    for (
      mn(h) && ((o = Vt(o)), (h = On(h, e, i)), (e = hn(t, e, r, o))),
        s = o,
        n = h,
        l = 0;
      l < s.length;
  ...
  return (
    mn(h) ||
      ((s = h),
      c
        ? (h = $t(h, !o.length || (16 & h && (!u || 32 & h)) ? 2 : 2048, !0))
        : i || (h = $t(h, 32, !1)),
      h !== s && Zt(o, h),
      c && Object.freeze(o)),
    a && mn(h) && ((o = Vt(o)), (h = On(h, e, i)), Zt(o, h), hn(t, e, r, o)),
    o
  );
}
function Rn(t, e, n) {
...
function Mn(t, e, n, r) {
  ...
  let i = Jt(t);
  de(i),
    (n = An(t, i, n)) && n !== e && null != r && (i = hn(t, i, n)),
    hn(t, i, e, r);
}
function On(t, e, n) {
  return (
    (t = $t(t, 2, !!(2 & e))), (t = $t(t, 32, !!(32 & e) && n)), $t(t, 2048, !1)
  );
}
function In(t, e, n) {
  t = t.s;
    ...
    throw (
      ...
      Error(
        `Expected boolean but got ${
          "object" != t ? t : n ? (Array.isArray(n) ? "array" : t) : "null"
        }: ${n}`
      ))
    );
  cn(t, e, n);
...
function Xn(t, e, n) {
  ...
  if (r && ce) {
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      if (h < t) {
        ...
        (u = c[h]),
          null == c[h] ? (c[h] = n ? le : Qt()) : n && u !== le && Yt(u);
      }
    }
  }
  ...
  if (ae((l = e[c - 1]))) {
    t: {
      var p = l;
      for (var g in ((s = {}), (n = !1), p))
        (t = p[g]),
          Array.isArray(t) &&
            ((a = t),
            ((!H && ue(t, r, +g)) || (!W && oe(t) && 0 === t.size)) &&
              (t = null),
            t != a && (n = !0)),
          null != t ? (s[g] = t) : (n = !0);
      if (n) {
  ...
  for (
    ...
    d = !0;
  return f || d
    ? ((e = o ? e : Array.prototype.slice.call(e, 0, c)),
      o && (e.length = c),
      p && e.push(p),
      e)
    : e;
...
function zn(t) {
  return Array.isArray(t) ? (t[0] instanceof jt ? t : [Xr, t]) : [t, void 0];
}
function Wn(t, e) {
  if (Array.isArray(e)) {
    var n = qt(e);
      ...
      : (t, e) => {
          for (; vt(e) && 4 != e.h; ) {
            ...
            (s && s(e, t, i)) ||
              ...
              s.ga
                ? (s = void 0)
                : ((o = s.g.g - i), (s.g.g = i), (s = mt(s.g, o))),
              (i = t),
              s &&
                ((me ||= Symbol()), (o = i[me]) ? o.push(s) : (i[me] = [s])));
          }
...
function nr(t, e, n, r, i = er) {
  ...
  for (c = 1; void 0 !== o; ) {
    ...
    for (
      u = c + 1,
        "number" == typeof (o = t[++s]) && 0 > o && ((u -= o), (o = t[++s]));
      c < u;
      c++
    ) {
      const t = a[c];
...
function cr(t) {
  ...
  return (
    e ||
    ((e = nr(t, (t[sr] = {}), or, ar)), hr in t && sr in t && (t.length = 0), e)
  );
}
const hr = Symbol();
function ur(t, e) {
...
function pr(t, e, n) {
  ...
  if (256 & r) {
    ...
    for (let t in r)
      (i = +t),
        Number.isNaN(i) || (null != (s = r[t]) && (a = dr(n, i)) && a(e, s, i));
  }
  if ((t = me ? t[me] : void 0))
    for (Pt(e, e.g.end()), n = 0; n < t.length; n++) Pt(e, D(t[n]) || O());
}
function gr(t, e) {
...
var _r = yr(
  function (t, e, n, r, i) {
    return (
      2 === t.h &&
      ((t = wt(t, Ge([void 0, void 0], r), i)),
      de((r = Jt(e))),
      (i = an(e, r, n)) instanceof Ye
        ? 0 != (2 & i.O)
          ? ((i = i.X()).push(t), hn(e, r, n, i))
          : i.Ta(t)
        : Array.isArray(i)
        ? (2 & qt(i) && hn(e, r, n, (i = _n(i))), i.push(t))
        : hn(e, r, n, [t]),
      !0)
    );
  },
...
function xr(t, e, n) {
  null !=
    (e =
      null == e || "string" == typeof e || F(e) || e instanceof B
        ? e
...
var Sr,
        ...
        if (be(e)) {
          if ("string" == typeof e) {
            ...
            Number.isSafeInteger(r) && 0 <= r
              ? (e = String(r))
              : (-1 !== (r = e.indexOf(".")) && (e = e.substring(0, r)),
                ke(e) || (it(e), (e = et($, q))));
            break t;
          }
          if ("number" == typeof e) {
  ...
  Br = gr(function (t, e, n) {
    return 0 === t.h && (vr(e, n, at(t.g)), !0);
  }, Er),
  Nr = gr(function (t, e, n) {
  ...
  Vr = gr(function (t, e, n) {
    return 2 === t.h && (vr(e, n, Tt(t)), !0);
  }, br),
  Xr = yr(function (t, e, n, r, i) {
    return 2 === t.h && (wt(t, xn(e, r, n, !0), i), !0);
  }, Ar),
  zr = yr(function (t, e, n, r, i) {
...
Sr = new jt(
  function (t, e, n, r, i) {
    ...
    return (
      (s = Jt(e)),
      4 & qt(o) && ((o = Vt(o)), Zt(o, -2079 & (1 | qt(o))), hn(e, s, n, o)),
      o.push(r),
      wt(t, r, i),
      !0
    );
  ...
  function (t, e, n, r, i) {
    if (Array.isArray(e))
      for (let s = 0; s < e.length; s++) Ar(t, e[s], n, r, i);
  },
  !0,
  !0
);
var Wr = yr(function (t, e, n, r, i, s) {
    ...
    return (
      de(o),
      (s = An(e, o, s)) && n !== s && hn(e, o, s),
      wt(t, (e = xn(e, r, n)), i),
      !0
    );
  }, Ar),
  Hr = gr(function (t, e, n) {
...
li[336783863] = [
  ...
  -1,
  Pr,
  [0, [1, 2, 3, 4, 5], Wr, ci, Wr, si, Wr, oi, Wr, hi, Wr, ni],
  ei,
];
var di = [0, jr, Nr],
  pi = [0, Ir, -1, Nr, -3, Ir, Ur, jr, Dr, Ir, -1, Nr, Dr, Nr, -2, jr],
  gi = [-1, {}],
  mi = [0, Vr, 1, gi],
  yi = [0, Vr, Gr, gi];
function vi(t, e) {
...
var Ei = [
  ...
  bi = [0, jr, -1, gi],
  Ai = [-500, Vr, -1, [-1, {}], 998, Vr],
  xi = [-500, Vr, Gr, -1, [-2, {}, Br], 997, Gr, -1],
  ki = [-500, Vr, Gr, gi, 998, Gr];
function Si(t, e) {
  In(t, Ti, e);
}
function Li(t, e) {
...
var _s = [0, Vr, Pr, Rr, Gr, -1],
  ...
  Ss = [0, xs, Br, [0, bs, Wr, hi, Wr, si, Wr, ni, Wr, ci, Wr, oi], Kr],
  Ls = class extends Vn {
    constructor(t) {
      super(t);
    }
    ...
    g() {
      ...
      return (
        (t = (function (t, e, n) {
          ...
          return (
            s || (64 & qt(n) ? Kt(n, 32) : 32 & e && Ht(n, 32)),
            hn(t, e, 2, (r = new Ye(n, r, Pe, void 0)), !1),
            r
          );
        })(t, e, an(t, e, 2))),
        null == t || (!n && ho && (t.xa = !0)),
...
li[458105876] = [0, co, _r, [!0, Or, [0, Vr, -1, Gr]]];
...
function bo(t, e) {
  return (
    ...
    void 0 !== t.displayNamesLocale
      ? cn(e, 1, Oe(t.displayNamesLocale))
      : void 0 === t.displayNamesLocale && cn(e, 1),
    void 0 !== t.maxResults
      ? Nn(e, 2, t.maxResults)
      : "maxResults" in t && cn(e, 2),
    void 0 !== t.scoreThreshold
      ? Gn(e, 3, t.scoreThreshold)
      : "scoreThreshold" in t && cn(e, 3),
    void 0 !== t.categoryAllowlist
      ? wn(e, 4, t.categoryAllowlist)
      : "categoryAllowlist" in t && cn(e, 4),
    void 0 !== t.categoryDenylist
      ? wn(e, 5, t.categoryDenylist)
      : "categoryDenylist" in t && cn(e, 5),
    e
  );
}
function Ao(t, e = -1, n = "") {
...
function ko(t) {
  const e = [];
  for (const n of Rn(t, ts, 1))
    e.push({ x: Dn(n, 1) ?? 0, y: Dn(n, 2) ?? 0, z: Dn(n, 3) ?? 0 });
  return e;
}
function So(t) {
  const e = [];
  for (const n of Rn(t, qi, 1))
    e.push({ x: Dn(n, 1) ?? 0, y: Dn(n, 2) ?? 0, z: Dn(n, 3) ?? 0 });
  return e;
}
function Lo(t) {
...
function Bo(t, e, n) {
  ...
  return (
    ...
    e.videoWidth
      ? ((n = e.videoWidth), (e = e.videoHeight))
      : e.naturalWidth
      ? ((n = e.naturalWidth), (e = e.naturalHeight))
      : ((n = e.width), (e = e.height)),
    !t.l ||
      (n === t.i.canvas.width && e === t.i.canvas.height) ||
      ((t.i.canvas.width = n), (t.i.canvas.height = e)),
    [n, e]
  );
}
function No(t, e, n) {
...
async function Vo(t, e, n, r) {
  return (
    (t = await (async (t, e, n, r, i) => {
      if ((e && (await Uo(e)), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      if (n && (await Uo(n), !self.ModuleFactory))
        throw Error("ModuleFactory not set.");
      return (
        self.Module &&
          i &&
...
function Xo(t, e) {
  ...
  "string" == typeof e
    ? (cn(n, 2, Oe(e)), cn(n, 1))
    : e instanceof Uint8Array && (cn(n, 1, he(e, !1, !1)), cn(n, 2)),
    Fn(t.baseOptions, 0, 1, n);
}
function zo(t) {
  try {
    const e = t.F.length;
    ...
    if (1 < e)
      throw Error(
        "Encountered multiple errors: " + t.F.map((t) => t.message).join(", ")
      );
  } finally {
    t.F = [];
  }
...
function Ho(t, e) {
  (t.C = new Ti()),
    vi(t.C, "PassThroughCalculator"),
    _i(t.C, "free_memory"),
    wi(t.C, "free_memory_unused_out"),
    Li(e, "free_memory"),
    Si(e, t.C);
}
function Yo(t, e) {
...
var $o = class {
  ...
  l(t, e = !0) {
    if (e) {
      ...
      if (
        !(
          Sn(this.baseOptions, As, 1)?.g() ||
          Sn(this.baseOptions, As, 1)?.h() ||
      ...
      if (
        ((function (t, e) {
          ...
          "delegate" in e &&
            ("GPU" === e.delegate
              ? ((e = n), (r = new ii()), Mn(e, 2, bs, r))
              : ((e = n), (r = new ai()), Mn(e, 4, bs, r))),
            Fn(t.baseOptions, 0, 3, n);
        })(this, e),
        e.modelAssetPath)
      )
...
function Qo(t, e) {
  ...
  n.bindBuffer(n.ARRAY_BUFFER, i),
    n.enableVertexAttribArray(t.N),
    n.vertexAttribPointer(t.N, 2, n.FLOAT, !1, 0, 0),
    n.bufferData(
      n.ARRAY_BUFFER,
  ...
  return (
    ...
    n.enableVertexAttribArray(t.M),
    n.vertexAttribPointer(t.M, 2, n.FLOAT, !1, 0, 0),
    n.bufferData(
      n.ARRAY_BUFFER,
...
function ea(t, e, n, r) {
  return (
    ...
    t.h || (t.m(), t.F()),
    n
      ? (t.u || (t.u = Qo(t, !0)), (n = t.u))
      : (t.v || (t.v = Qo(t, !1)), (n = t.v)),
    e.useProgram(t.h),
    n.bind(),
    t.l(),
    (t = r()),
...
function ra(t, e, n) {
  ta(t, e),
    t.C || (t.C = qo(e.createFramebuffer(), "Failed to create framebuffe.")),
    e.bindFramebuffer(e.FRAMEBUFFER, t.C),
...
var sa = class {
  ...
  m() {
    ...
    if (
      ...
      (this.sa = Zo(this, this.I(), t.FRAGMENT_SHADER)),
    ...
    (this.N = t.getAttribLocation(this.h, "aVertex")),
      (this.M = t.getAttribLocation(this.h, "aTex"));
  }
  F() {}
  l() {}
  close() {
...
var oa = class extends sa {
    ...
    F() {
      ...
      t.activeTexture(t.TEXTURE1),
        (this.B = na(this, t, t.LINEAR)),
        t.activeTexture(t.TEXTURE2),
        (this.j = na(this, t, t.NEAREST));
    }
    m() {
      super.m();
      const t = this.g;
...
function pa(t) {
  ...
  return (
    n ||
      ((n = na(da(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
        ...
        if (e instanceof Uint8Array) n = new Uint8Array(e);
            ...
            throw Error(`Type is not supported: ${e}`);
          {
            const t = la(this),
              e = da(this);
            t.activeTexture(t.TEXTURE1),
              (n = na(e, t, this.m ? t.LINEAR : t.NEAREST)),
...
(ya.prototype.close = ya.prototype.close),
  (ya.prototype.clone = ya.prototype.clone),
  (ya.prototype.getAsWebGLTexture = ya.prototype.K),
  (ya.prototype.getAsFloat32Array = ya.prototype.ia),
  (ya.prototype.getAsUint8Array = ya.prototype.ja),
  (ya.prototype.hasWebGLTexture = ya.prototype.P),
  (ya.prototype.hasFloat32Array = ya.prototype.ka),
  (ya.prototype.hasUint8Array = ya.prototype.La);
var va = 250;
const _a = { color: "white", lineWidth: 4, radius: 6 };
function wa(t) {
  return { ..._a, fillColor: (t = t || {}).color, ...t };
}
function Ta(t, e) {
...
function xa(t, e, n) {
  if (e.P()) n(e.K());
    ...
    t.m = t.m ?? new sa();
    const i = Aa(t);
    n((t = new ya([r], e.m, !1, i.canvas, t.m, e.width, e.height)).K()),
      t.close();
  }
}
function ka(t, e, n, r) {
  ...
  Ea(t, e) {
    if (t) {
      ...
      var r = n.canvas,
        i = 0;
      for (const s of t)
        (n.fillStyle = Ta(e.fillColor, { index: i, from: s })),
          (n.strokeStyle = Ta(e.color, { index: i, from: s })),
          (n.lineWidth = Ta(e.lineWidth, { index: i, from: s })),
          (t = new Path2D()).arc(
            s.x * r.width,
            s.y * r.height,
            Ta(e.radius, { index: i, from: s }),
            0,
            2 * Math.PI
          ),
          n.fill(t),
  ...
  Da(t, e, n) {
    if (t && e) {
      ...
      for (const o of e) {
        ...
        e &&
          a &&
          ((r.strokeStyle = Ta(n.color, { index: s, from: e, to: a })),
          (r.lineWidth = Ta(n.lineWidth, { index: s, from: e, to: a })),
...
function Ca(t) {
  ...
  let n = Ra(t, 2);
  return (
    n || ((n = na(Ia(t), e)), t.g.push(n), (t.m = !0)),
    e.bindTexture(e.TEXTURE_2D, n),
    n
  );
}
...
(La.prototype.close = La.prototype.close),
  (La.prototype.drawConfidenceMask = La.prototype.Ca),
  (La.prototype.drawCategoryMask = La.prototype.Ba),
  (La.prototype.drawBoundingBox = La.prototype.Aa),
  (La.prototype.drawConnectors = La.prototype.Da),
  (La.prototype.drawLandmarks = La.prototype.Ea),
  (La.lerp = function (t, e, n, r, i) {
...
var Da = class {
  ...
  close() {
    this.j && Ra(this, 1).close(),
      this.m && Oa(this).deleteTexture(Ra(this, 2)),
      (Ba = -1);
  }
};
(Da.prototype.close = Da.prototype.close),
  (Da.prototype.clone = Da.prototype.clone),
  (Da.prototype.getAsWebGLTexture = Da.prototype.K),
  (Da.prototype.getAsImageBitmap = Da.prototype.Ha),
  (Da.prototype.getAsImageData = Da.prototype.Ia),
  (Da.prototype.hasWebGLTexture = Da.prototype.P),
  (Da.prototype.hasImageBitmap = Da.prototype.la),
  (Da.prototype.hasImageData = Da.prototype.Ka);
var Ba = 250;
function Na(...t) {
  ...
  ((ja = class {
    constructor(t, e) {
      (this.l = !0),
        ...
        void 0 !== e
          ? (this.i.canvas = e)
          : "undefined" == typeof OffscreenCanvas || Po()
          ? (console.warn(
...
function za(t, e, n, r) {
  if (t.J) {
    ...
    if (n?.regionOfInterest) {
      ...
      Gn(s, 1, (i.left + i.right) / 2),
        Gn(s, 2, (i.top + i.bottom) / 2),
        Gn(s, 4, i.right - i.left),
        Gn(s, 3, i.bottom - i.top);
    } else Gn(s, 1, 0.5), Gn(s, 2, 0.5), Gn(s, 4, 1), Gn(s, 3, 1);
    if (n?.rotationDegrees) {
      if (0 != n?.rotationDegrees % 90)
        throw Error("Expected rotation to be a multiple of 90°.");
      if (
        (Gn(s, 5, (-Math.PI * n.rotationDegrees) / 180),
...
function Ya(t, e, n, r) {
  ...
  return (t = new ya([i], n, !1, t.g.i.canvas, t.M, s, e)), r ? t.clone() : t;
}
var Ka = class extends $o {
  ...
  l(t, e = !0) {
    if (
      ("runningMode" in t &&
        Bn(this.baseOptions, 2, !!t.runningMode && "IMAGE" !== t.runningMode),
...
var $a = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect_in", !1),
      (this.j = { detections: [] }),
      Fn((t = this.h = new Ls()), 0, 1, (e = new ks())),
      Gn(this.h, 2, 0.5),
      Gn(this.h, 3, 0.3);
  }
  get baseOptions() {
  ...
  o(t) {
    return (
      "minDetectionConfidence" in t &&
        Gn(this.h, 2, t.minDetectionConfidence ?? 0.5),
      "minSuppressionThreshold" in t &&
        Gn(this.h, 3, t.minSuppressionThreshold ?? 0.3),
      this.l(t)
    );
  }
  G(t, e) {
    return (this.j = { detections: [] }), Wa(this, t, e), this.j;
  }
  H(t, e, n) {
    return (this.j = { detections: [] }), Ha(this, t, n, e), this.j;
  }
  m() {
    var t = new Fi();
    ...
    jn(e, Fs, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect_in"),
...
($a.prototype.detectForVideo = $a.prototype.H),
  ($a.prototype.detect = $a.prototype.G),
  ($a.prototype.setOptions = $a.prototype.o),
  ($a.createFromModelPath = async function (t, e) {
    return Xa($a, t, { baseOptions: { modelAssetPath: e } });
  }),
  ($a.createFromModelBuffer = function (t, e) {
    return Xa($a, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var qa = Na(
  ...
  Qa = Na([474, 475], [475, 476], [476, 477], [477, 474]),
  tc = Na(
    [33, 7],
    [7, 163],
    [163, 144],
  ...
  nc = Na([469, 470], [470, 471], [471, 472], [472, 469]),
  rc = Na(
    [10, 338],
    [338, 297],
    [297, 332],
...
var ac = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect", !1),
      (this.j = {
        faceLandmarks: [],
        faceBlendshapes: [],
        facialTransformationMatrixes: [],
      ...
      (this.outputFacialTransformationMatrixes = this.outputFaceBlendshapes =
        !1),
      Fn((t = this.h = new Ds()), 0, 1, (e = new ks())),
      (this.v = new Ps()),
      Fn(this.h, 0, 3, this.v),
      (this.u = new Ls()),
      Fn(this.h, 0, 2, this.u),
      Nn(this.u, 4, 1),
      Gn(this.u, 2, 0.5),
      Gn(this.v, 2, 0.5),
      Gn(this.h, 4, 0.5);
  ...
  o(t) {
    return (
      "numFaces" in t && Nn(this.u, 4, t.numFaces ?? 1),
      "minFaceDetectionConfidence" in t &&
        Gn(this.u, 2, t.minFaceDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        Gn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minFacePresenceConfidence" in t &&
        Gn(this.v, 2, t.minFacePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    jn(e, Ns, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoVectorListener("blendshapes", (t, e) => {
          if (this.outputFaceBlendshapes)
            for (const e of t)
              (t = Bi(e)), this.j.faceBlendshapes.push(Ao(t.g() ?? []));
          Wo(this, e);
        }),
...
(ac.prototype.detectForVideo = ac.prototype.H),
  (ac.prototype.detect = ac.prototype.G),
  (ac.prototype.setOptions = ac.prototype.o),
  (ac.createFromModelPath = function (t, e) {
    return Xa(ac, t, { baseOptions: { modelAssetPath: e } });
  }),
  (ac.createFromModelBuffer = function (t, e) {
    return Xa(ac, t, { baseOptions: { modelAssetBuffer: e } });
  }),
  (ac.createFromOptions = function (t, e) {
    return Xa(ac, t, e);
  }),
  (ac.FACE_LANDMARKS_LIPS = qa),
  (ac.FACE_LANDMARKS_LEFT_EYE = Ja),
  (ac.FACE_LANDMARKS_LEFT_EYEBROW = Za),
  (ac.FACE_LANDMARKS_LEFT_IRIS = Qa),
  (ac.FACE_LANDMARKS_RIGHT_EYE = tc),
  (ac.FACE_LANDMARKS_RIGHT_EYEBROW = ec),
  (ac.FACE_LANDMARKS_RIGHT_IRIS = nc),
  (ac.FACE_LANDMARKS_FACE_OVAL = rc),
  (ac.FACE_LANDMARKS_CONTOURS = ic),
  (ac.FACE_LANDMARKS_TESSELATION = sc);
var cc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect", !0),
      Fn((t = this.j = new Gs()), 0, 1, (e = new ks()));
  }
  get baseOptions() {
  ...
  Ua(t, e, n) {
    ...
    if (
      ((this.h = "function" == typeof e ? e : n), Wa(this, t, r ?? {}), !this.h)
    )
      return this.u;
  }
  m() {
    ...
    jn(e, js, this.j);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
      wi(n, "STYLIZED_IMAGE:stylized_image"),
      n.o(e),
      Si(t, n),
      this.g.ba("stylized_image", (t, e) => {
        var n = !this.h,
          r = t.data,
          i = t.width;
        ...
        (i = new Da([r], !1, !1, this.g.i.canvas, this.M, i, t)),
...
(cc.prototype.stylize = cc.prototype.Ua),
  (cc.prototype.setOptions = cc.prototype.o),
  (cc.createFromModelPath = function (t, e) {
    return Xa(cc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (cc.createFromModelBuffer = function (t, e) {
    return Xa(cc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var dc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect", !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      Fn((t = this.v = new Qs()), 0, 1, (e = new ks())),
      (this.B = new Js()),
      Fn(this.v, 0, 2, this.B),
      (this.u = new $s()),
      Fn(this.B, 0, 3, this.u),
      (this.h = new Ys()),
      Fn(this.B, 0, 2, this.h),
      (this.j = new Ws()),
      Fn(this.v, 0, 3, this.j),
      Gn(this.h, 2, 0.5),
      Gn(this.B, 4, 0.5),
      Gn(this.u, 2, 0.5);
  }
  ...
  o(t) {
    if (
      (Nn(this.h, 3, t.numHands ?? 1),
      "minHandDetectionConfidence" in t &&
        Gn(this.h, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        Gn(this.B, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        Gn(this.u, 2, t.minHandPresenceConfidence ?? 0.5),
      t.cannedGesturesClassifierOptions)
    ) {
      var e = new Vs(),
        n = e,
        r = bo(t.cannedGesturesClassifierOptions, Sn(this.j, Vs, 3)?.h());
      Fn(n, 0, 2, r), Fn(this.j, 0, 3, e);
    } else
      void 0 === t.cannedGesturesClassifierOptions && Sn(this.j, Vs, 3)?.g();
    return (
      t.customGesturesClassifierOptions
        ? (Fn(
            ...
            0,
            2,
            (r = bo(t.customGesturesClassifierOptions, Sn(this.j, Vs, 4)?.h()))
          ),
          Fn(this.j, 0, 4, e))
    ...
    vi(n, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"),
      ...
      this.g.attachProtoVectorListener("hand_landmarks", (t, e) => {
        for (const e of t) {
          t = rs(e);
          const n = [];
          for (const e of Rn(t, ts, 1))
            n.push({ x: Dn(e, 1) ?? 0, y: Dn(e, 2) ?? 0, z: Dn(e, 3) ?? 0 });
...
(dc.prototype.recognizeForVideo = dc.prototype.Qa),
  (dc.prototype.recognize = dc.prototype.Pa),
  (dc.prototype.setOptions = dc.prototype.o),
  (dc.createFromModelPath = function (t, e) {
    return Xa(dc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (dc.createFromModelBuffer = function (t, e) {
    return Xa(dc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var gc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect", !1),
      ...
      (this.worldLandmarks = []),
      (this.handedness = []),
      Fn((t = this.j = new Js()), 0, 1, (e = new ks())),
      (this.u = new $s()),
      Fn(this.j, 0, 3, this.u),
      (this.h = new Ys()),
      Fn(this.j, 0, 2, this.h),
      Nn(this.h, 3, 1),
      Gn(this.h, 2, 0.5),
      Gn(this.u, 2, 0.5),
      Gn(this.j, 4, 0.5);
  ...
  o(t) {
    return (
      "numHands" in t && Nn(this.h, 3, t.numHands ?? 1),
      "minHandDetectionConfidence" in t &&
        Gn(this.h, 2, t.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        Gn(this.j, 4, t.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t &&
        Gn(this.u, 2, t.minHandPresenceConfidence ?? 0.5),
      this.l(t)
    );
  ...
  m() {
    ...
    jn(e, eo, this.j);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
      wi(n, "LANDMARKS:hand_landmarks"),
      wi(n, "WORLD_LANDMARKS:world_hand_landmarks"),
...
(gc.prototype.detectForVideo = gc.prototype.H),
  (gc.prototype.detect = gc.prototype.G),
  (gc.prototype.setOptions = gc.prototype.o),
  (gc.createFromModelPath = function (t, e) {
    return Xa(gc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (gc.createFromModelBuffer = function (t, e) {
    return Xa(gc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var mc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "input_image", "norm_rect", !0),
  ...
  ya(t, e) {
    return (this.j = { classifications: [] }), Wa(this, t, e), this.j;
  }
  za(t, e, n) {
    return (this.j = { classifications: [] }), Ha(this, t, n, e), this.j;
  }
  m() {
    var t = new Fi();
    ...
    jn(e, io, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"),
      _i(n, "IMAGE:input_image"),
      _i(n, "NORM_RECT:norm_rect"),
      ...
      this.g.attachProtoListener("classifications", (t, e) => {
        (this.j = (function (t) {
          const e = {
            classifications: Rn(t, as, 1).map((t) =>
              Ao(Sn(t, Ui, 4)?.g() ?? [], Un(Cn(t, 2)), Pn(t, 3) ?? "")
            ),
          };
...
(mc.prototype.classifyForVideo = mc.prototype.za),
  (mc.prototype.classify = mc.prototype.ya),
  (mc.prototype.setOptions = mc.prototype.o),
  (mc.createFromModelPath = function (t, e) {
    return Xa(mc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (mc.createFromModelBuffer = function (t, e) {
    return Xa(mc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var yc = class extends Ka {
  ...
  o(t) {
    ...
    return (
      ...
      void 0 !== t.l2Normalize
        ? Bn(n, 1, t.l2Normalize)
        : "l2Normalize" in t && cn(n, 1),
      void 0 !== t.quantize
        ? Bn(n, 2, t.quantize)
        : "quantize" in t && cn(n, 2),
      Fn(e, 0, 2, n),
      this.l(t)
    );
  }
  ...
  m() {
    ...
    jn(e, oo, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
          ...
          (this.embeddings = (function (t) {
            return {
              embeddings: Rn(t, ds, 1).map((t) => {
                ...
                if (void 0 !== kn(t, ls, bn(t, 1)))
                  (t = dn((t = Sn(t, ls, bn(t, 1))), 1, we)),
                    (e.floatEmbedding = t);
                else {
...
(yc.cosineSimilarity = function (t, e) {
  if (t.floatEmbedding && e.floatEmbedding)
    t = Ro(t.floatEmbedding, e.floatEmbedding);
  else {
  ...
  (yc.prototype.embedForVideo = yc.prototype.Ga),
  (yc.prototype.embed = yc.prototype.Fa),
  (yc.prototype.setOptions = yc.prototype.o),
  (yc.createFromModelPath = function (t, e) {
    return Xa(yc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (yc.createFromModelBuffer = function (t, e) {
    return Xa(yc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Tc = class extends Ka {
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ? cn(this.h, 2, Oe(t.displayNamesLocale))
        : "displayNamesLocale" in t && cn(this.h, 2),
  ...
  N() {
    !(function (t) {
      ...
      1 === e.length &&
        (Sn(e[0], ui, 7)?.l()?.g() ?? new Map()).forEach((e, n) => {
          t.u[Number(n)] = Pn(e, 1) ?? "";
        });
    })(this);
  }
  ...
  m() {
    ...
    jn(e, fo, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
      n.o(e),
      Si(t, n),
      ...
      this.outputConfidenceMasks &&
        (Ri(t, "confidence_masks"),
        wi(n, "CONFIDENCE_MASKS:confidence_masks"),
        Yo(this, "confidence_masks"),
        this.g.ca("confidence_masks", (t, e) => {
          (this.confidenceMasks = t.map((t) => Ya(this, t, !0, !this.j))),
            Wo(this, e);
        }),
...
(Tc.prototype.getLabels = Tc.prototype.Ja),
  (Tc.prototype.segmentForVideo = Tc.prototype.Sa),
  (Tc.prototype.segment = Tc.prototype.ea),
  (Tc.prototype.setOptions = Tc.prototype.o),
  (Tc.createFromModelPath = function (t, e) {
    return Xa(Tc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Tc.createFromModelBuffer = function (t, e) {
    return Xa(Tc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Vc = class extends Ka {
  ...
  ea(t, e, n, r) {
    ...
    const s = new Dc();
    var o = new bc();
    if ((Nn(o, 1, 255), Fn(s, 0, 12, o), e.keypoint && e.scribble))
    ...
    if (e.keypoint) {
      ...
      for (a of ((o = new Uc()), e.scribble))
        Bn((e = new Cc()), 3, !0), Gn(e, 1, a.x), Gn(e, 2, a.y), In(o, Cc, e);
      Mn(s, 15, Bc, o);
    }
    In(r, Dc, s),
...
(Vc.prototype.segment = Vc.prototype.ea),
  (Vc.prototype.setOptions = Vc.prototype.o),
  (Vc.createFromModelPath = function (t, e) {
    return Xa(Vc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Vc.createFromModelBuffer = function (t, e) {
    return Xa(Vc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Xc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "input_frame_gpu", "norm_rect", !1),
      (this.j = { detections: [] }),
  ...
  o(t) {
    return (
      void 0 !== t.displayNamesLocale
        ...
        : "displayNamesLocale" in t && cn(this.h, 2),
      void 0 !== t.maxResults
        ? Nn(this.h, 3, t.maxResults)
        : "maxResults" in t && cn(this.h, 3),
      void 0 !== t.scoreThreshold
        ? Gn(this.h, 4, t.scoreThreshold)
        : "scoreThreshold" in t && cn(this.h, 4),
      void 0 !== t.categoryAllowlist
        ? wn(this.h, 5, t.categoryAllowlist)
        : "categoryAllowlist" in t && cn(this.h, 5),
      void 0 !== t.categoryDenylist
        ? wn(this.h, 6, t.categoryDenylist)
        : "categoryDenylist" in t && cn(this.h, 6),
      this.l(t)
    );
  }
  G(t, e) {
  ...
  m() {
    ...
    jn(e, go, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.ObjectDetectorGraph"),
      _i(n, "IMAGE:input_frame_gpu"),
      _i(n, "NORM_RECT:norm_rect"),
      wi(n, "DETECTIONS:detections"),
      n.o(e),
      Si(t, n),
...
(Xc.prototype.detectForVideo = Xc.prototype.H),
  (Xc.prototype.detect = Xc.prototype.G),
  (Xc.prototype.setOptions = Xc.prototype.o),
  (Xc.createFromModelPath = async function (t, e) {
    return Xa(Xc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Xc.createFromModelBuffer = function (t, e) {
    return Xa(Xc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
var Hc = class extends Ka {
  constructor(t, e) {
    super(new Va(t, e), "image_in", "norm_rect", !1),
      ...
      Fn((t = this.h = new wo()), 0, 1, (e = new ks())),
      (this.B = new vo()),
      Fn(this.h, 0, 3, this.B),
      (this.j = new mo()),
      Fn(this.h, 0, 2, this.j),
      Nn(this.j, 4, 1),
      Gn(this.j, 2, 0.5),
      Gn(this.B, 2, 0.5),
      Gn(this.h, 4, 0.5);
  ...
  o(t) {
    return (
      "numPoses" in t && Nn(this.j, 4, t.numPoses ?? 1),
      "minPoseDetectionConfidence" in t &&
        Gn(this.j, 2, t.minPoseDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t &&
        Gn(this.h, 4, t.minTrackingConfidence ?? 0.5),
      "minPosePresenceConfidence" in t &&
        Gn(this.B, 2, t.minPosePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    Li(t, "image_in"),
      Li(t, "norm_rect"),
      Ri(t, "normalized_landmarks"),
      Ri(t, "world_landmarks"),
      Ri(t, "segmentation_masks");
    const e = new ui();
    jn(e, Eo, this.h);
    const n = new Ti();
    vi(n, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      _i(n, "IMAGE:image_in"),
      _i(n, "NORM_RECT:norm_rect"),
      ...
      this.outputSegmentationMasks &&
        ...
        this.g.ca("segmentation_masks", (t, e) => {
...
(Hc.prototype.detectForVideo = Hc.prototype.H),
  (Hc.prototype.detect = Hc.prototype.G),
  (Hc.prototype.setOptions = Hc.prototype.o),
  (Hc.createFromModelPath = function (t, e) {
    return Xa(Hc, t, { baseOptions: { modelAssetPath: e } });
  }),
  (Hc.createFromModelBuffer = function (t, e) {
    return Xa(Hc, t, { baseOptions: { modelAssetBuffer: e } });
  }),
...
export {
  ...
  dc as GestureRecognizer,
  gc as HandLandmarker,
  mc as ImageClassifier,
  yc as ImageEmbedder,
  Tc as ImageSegmenter,
  vc as ImageSegmenterResult,
  Vc as InteractiveSegmenter,
  Ec as InteractiveSegmenterResult,
  Da as MPImage,
  ya as MPMask,
  Xc as ObjectDetector,
  Hc as PoseLandmarker,
  $o as TaskRunner,
  Ka as VisionTaskRunner,
};
